              ...
              >
                <Dialog.Panel className="w-[360px] transform overflow-hidden rounded-2xl bg-white p-8 text-left align-middle shadow-xl transition-all">
                    ...
                    <div className="mt-4 flex items-center">
                      <div className="overflow-hidden rounded-xl">
                        <img
                          src={avatar}
                          alt="User"
                          className="h-[48px] w-[48px] overflow-hidden rounded-xl"
                        />
                      </div>
                      <div className="ml-4">
                        <p className="text-sm font-medium">{nama_penjual}</p>
                  ...
                  <button
                    ...
                    className="group relative mt-4 inline-flex w-full justify-center rounded-2xl bg-olive-04 px-4 py-3 text-sm font-medium text-white transition duration-300 hover:bg-olive-02 hover:text-neutral-04"
                  >
