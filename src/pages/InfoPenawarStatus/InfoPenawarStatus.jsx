          ...
          <div className="mx-auto flex w-full flex-wrap justify-center lg:w-[800px] lg:flex-nowrap lg:gap-[76px]">
            ...
            <div className="w-full">
              ...
              <div className="border-b-neutral-01 mt-4 flex justify-center border-b-2 pb-4 md:justify-end">
                <button
                  onClick={openModal}
                  className="rounded-2xl border border-purple-04 bg-white px-3 py-1 text-sm font-medium transition duration-300 hover:bg-purple-03 hover:text-white sm:px-12 sm:py-2"
                >
                  Status
                </button>
                <button className="group relative ml-4 rounded-2xl border border-purple-04 bg-purple-04 px-10 py-2 text-sm font-medium text-white transition duration-300 hover:bg-purple-03 lg:px-12">
                  Hubungi di
